...
function startCountdown(targetDate, daysId, hoursId, minutesId, secondsId) {
  ...
  if (!daysEl || !hoursEl || !minutesEl || !secondsEl) {
    return; // Elements not present on this page/section
  }
  ...
  var countdownFunction = setInterval(function () {
      ...
      if (distance <= 0) {
          ...
          daysEl.innerHTML = "0 <span>DAYS</span>";
          hoursEl.innerHTML = "0 <span>Hours</span>";
          minutesEl.innerHTML = "0 <span>Minutes</span>";
          secondsEl.innerHTML = "0 <span>Seconds</span>";
      }
  }, 1000);
}

// Countdown to closing date: 13 November 2026 23:59:59 (local time)
// Note: JS Date months are 0-indexed; 10 = November
var targetDate = new Date(2026, 10, 13, 23, 59, 59);

// Apply countdown to all known timer ID sets across pages
